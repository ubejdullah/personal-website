...
const items = [
    { icon: 'fab fa-github', link: 'https://github.com/ubejdullah' },
  ]

const navItems = [
    { icon: 'fal fa-home', active: 'fa fa-home', label: 'Home', href: '/' },
    { icon: 'fal fa-compass', active: 'fa fa-compass', label: 'Projekte', href: '/projects' },
    { icon: 'fal fa-phone', active: 'fa fa-phone', label: 'Kontakt', href: '/contact' },
]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">Ubejdullah Gashi</p>
